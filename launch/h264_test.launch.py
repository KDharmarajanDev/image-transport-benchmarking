...
def generate_launch_description():
    ...
    image_listener_node = fogros2.CloudNode(
        package="image_transport_benchmarker", executable="h264_test_cloud", output="screen",
        machine = machine1, stream_topics=[('/camera/image_raw', 'h264')])
    image_listener_node_robot = Node(
        package="image_transport_benchmarker", executable="h264_test", output="screen")
